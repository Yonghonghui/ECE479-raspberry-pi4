...
def face_detection():
	...
	encodingsP = "module/encodings.pickle"
...
# 				print(name)
# 				if((len(encondings) == 1) & (name == "Unknown")):
					
				#If someone in your dataset is identified, print their name on the screen
				if currentname != name:
					currentname = name
					print(currentname)
					print("Pi have detected Owner")
					detected_signal = 1
					
			else: text_to_speech("sorry, you have no access to chatpi")
